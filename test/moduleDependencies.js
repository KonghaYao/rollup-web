...
import { drawDependence, MapperStore } from "../dist/plugins/drawDependence.js";
import json from "https://esm.sh/@rollup/plugin-json";
await initBabel();
const server = new DynamicServer("_import_module_dependencies");
export const moduleDependencies = async () => {
    const config = {
        ...
        plugins: [
            ...
            drawDependence({
                log(mapperTag, newestMapper) {
                    console.log(mapperTag, newestMapper);
                },
                mapperTag: "default",
            }),
        ],
